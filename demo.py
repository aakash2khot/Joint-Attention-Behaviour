# python3 demo.py  --snapshot models/L2CSNet_gaze360.pkl  --file Videos/10sec_no_sound.mp4 --gpu -1
        ...
        while cap.isOpened():
            ...
            if faces is not None: 
                for box, landmarks, score in faces:
                    ...
                    p.append(((x_min+bbox_width)/2.0, (y_min+bbox_height)/2.0))
                ...
                if t==5 and len(p)>1:
                    ...
                    if point is not None:
                        ...
                        if is_object_detected_around_point(point, object_detector(frame)):
                           print("Object detected around the point")
